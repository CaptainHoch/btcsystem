...
__all__ = ['no_loop', 'loop', 'redraw', 'size', 'title', 'no_cursor', 'run_sketch', 'set_sketch',
           'cursor', 'exit', 'draw', 'setup', 'run', 'save_frame', 'save', 'get_canvas']
...
def set_sketch(sketch_setup, sketch_draw, handlers=dict(), frame_rate=60):
    """Run a sketch.
